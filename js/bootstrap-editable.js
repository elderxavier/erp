...
(function ($) {
    ...
    $.fn.editable.defaults = {
        ...
        formTemplate:'<form class="form-inline" autocomplete="off">' + 
                       ...
                       '&nbsp;<button type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-ok"></i></button>&nbsp;<button type="button" class="btn editable-cancel"><i class="glyphicon glyphicon-remove"></i></button>' +
