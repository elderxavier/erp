        ...
        <div class="col-lg-12">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <div class="radio">
                        <label>
                            <input type="radio" name="ProductCardForm[units]" value="units" checked>
<!--                            --><?php //echo $form->radioButton($form_mdl,'units',array('value' => 'units', 'checked' => 'checked')); ?>
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="ProductCardForm[units]" value="kg">
<!--                            --><?php //echo $form->radioButton($form_mdl,'units',array('value' => 'kg')); ?>
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="ProductCardForm[units]" value="liters">
