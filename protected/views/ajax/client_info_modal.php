...
<div class="modal-footer">
    ...
    <a href="<?php echo Yii::app()->createUrl('/sell/nextStepCreate',array('cid' => $data->id)) ?>" type="button" class="btn btn-primary"><?php echo $this->labels['continue']; ?><span class="glyphicon glyphicon-share-alt"></span></a>
</div><!--/modal-footer -->