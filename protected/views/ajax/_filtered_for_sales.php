        ...
        <tr>
            ...
            <td>
                <?php if($item->stock->location->id == Yii::app()->user->getState('city_id')): ?>
                    <a data-name="<?php echo $item->productCard->product_name; ?>" data-code="<?php echo $item->productCard->product_code; ?>" data-quant='<?php echo $item->qnt;?>' data-unit="<?php echo $item->productCard->measureUnits->name; ?>" data-id="<?php echo $item->productCard->id;?>" class="btn btn-default btn-sm add-prod clearfix" href="#">
