        ...
        <div class="col-lg-12">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <?php echo $form->textField($form_mdl,'weight',array('class'=>'form-control', 'value' => ''));?>
                    <?php echo $form->error($form_mdl,'weight'); ?>
                </div>

                <div class="form-group">
                    <?php echo $form->label($form_mdl,'weight_net');?>
                    <?php echo $form->textField($form_mdl,'weight_net',array('class'=>'form-control', 'value' => ''));?>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <?php echo $form->textField($form_mdl,'width',array('class'=>'form-control', 'value' => ''));?>
                    <?php echo $form->error($form_mdl,'width'); ?>
                </div>

                <div class="form-group">
                    <?php echo $form->label($form_mdl,'height');?>
                    <?php echo $form->textField($form_mdl,'height',array('class'=>'form-control', 'value' => ''));?>
                    <?php echo $form->error($form_mdl,'height'); ?>
                </div>

                <div class="form-group">
                    <?php echo $form->label($form_mdl,'length');?>
                    <?php echo $form->textField($form_mdl,'length',array('class'=>'form-control', 'value' => ''));?>
