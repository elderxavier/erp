...
<div class="table-holder header-holder">
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                <th><?php echo $this->labels['company name']; ?></th>
...
<div class="new-cust-btn-holder">
	<button data-toggle="modal" data-target=".new-customer-juridical"><?php echo $this->labels['new company']; ?><span class="glyphicon glyphicon-plus-sign"></span></button>
